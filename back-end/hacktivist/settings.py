...
SECRET_KEY = 'django-insecure-stn@)9a%5h1_2rh7uqw=e(ukbw28&ikp=p7&_!1(pp3u1(wj$e'
...
# Or, for more permissive local development (less secure):
...
MIDDLEWARE = [
    # Add CorsMiddleware right near the top
